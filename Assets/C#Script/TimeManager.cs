    ...
    void Tick()
        ...
        public struct DateTime
        {
            ...
            public void AdvanceMinutes (int SecondsToAdvanceBy) 
            {
                ...
                {
                   minutes =  minutes + SecondsToAdvanceBy;
                }
            }
            ...
            {
                if (year == 0) year = 1; return new DateTime (1, 0, year, 6, 0);
            }
            ...
            // }
            // public DateTime StartOfSpring(int season, int year){
            //       return StartOfSeason(2,year);

            // }
            // public DateTime StartOfSummer(int season, int year){
            //       return StartOfSeason(1,year);

            // }
            // public DateTime StartOfAutumn(int season, int year){
            //     return StartOfSeason(2,year);

            // }
            // public DateTime StartOfWinter(int season, int year){
