...
public class FirebaseManager : MonoBehaviour
{
    ...
    private IEnumerator UpdateEnergy(int _energy)
    {
        ...
        var DBTask = DBreference.Child("users").Child(User.UserId).Child("energy").SetValueAsync(_energy);
        ...
        {
            //Energy are now updated
        }
    }

    private IEnumerator UpdateHappy(int _happy)
    {
        //Set the currently logged in user happy
        var DBTask = DBreference.Child("users").Child(User.UserId).Child("happy").SetValueAsync(_happy);
    ...
    {
        //Get all the users data ordered by energy amount
        var DBTask = DBreference.Child("users").OrderByChild("energy").GetValueAsync();
        ...
        else
        {
            ...
            foreach (DataSnapshot childSnapshot in snapshot.Children.Reverse<DataSnapshot>())
            {
                ...
                int energy = int.Parse(childSnapshot.Child("energy").Value.ToString());
                int happy = int.Parse(childSnapshot.Child("happy").Value.ToString());
                int coins = int.Parse(childSnapshot.Child("coins").Value.ToString());

                //Instantiate new scoreboard elements
                GameObject scoreboardElement = Instantiate(scoreElement, scoreboardContent);
                scoreboardElement.GetComponent<ScoreElement>().NewScoreElement(username, energy, happy, coins);
            }
